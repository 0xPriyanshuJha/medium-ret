    ...
    <div className="bg-brandGreen flex flex-col items-center justify-center">
      <div className="max-w-7xl flex w-full">
        <div className="w-1/2 border-r-[1.5px] border-black p-6 flex flex-col">
          ...
          <img src={mrect} alt="Mrect" className='h-[150px] w-[250px] pt-8'/>
          <p className='pt-8 text-sm'>Enjoy unlimited access to every story across all of your devices.</p>
        </div>
        <div className="w-1/2 p-6">
          <p className="text-black mb-5 text-4xl font-primary">Reward quality content.</p>
          <img src={mfount} alt="Mfount" className='h-[130px] w-[250px] pt-2'/>
          <p className='pt-6 text-sm'>Enjoy unlimited access to every story across all of your devices.</p>
        </div>
      </div>
